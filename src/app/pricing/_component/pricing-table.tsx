...
export default function PricingTable({
  ...
  const getDiscountedPrice = (originalPrice: number) => {
    const isDevMode =
      discountConfig.dev || process.env.NODE_ENV === "development";
    ...
    if (discountConfig.percentage) {
      return Math.round(
        originalPrice - (originalPrice * discountConfig.percentage) / 100
      );
    }
    ...
    try {
      if (paymentMethod === "dodo") {
        ...
        if (discountConfig.isStudentDiscount) {
          ...
          toast.success(
            `💰 Discount "${discountConfig.code}" applied automatically!`
          );
        }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-medium text-foreground mb-4 font-be-vietnam-pro">
            Pricing
          </h1>
          ...
          <Card className="relative border-2 border-primary">
              ...
              <div className="absolute -top-3 right-4 z-10">
                <Badge variant="secondary">
                  {discountConfig.showPrice && discountConfig.finalPrice
                    ? `$${
                        PRICING.PRO_MONTHLY - discountConfig.finalPrice
                      } OFF for a year`
                    : discountConfig.percentage
            ...
            <CardContent className="space-y-6">
              ...
              {hasProAccess() ? (
                <div className="space-y-4">
                    ...
                    subscriptionDetails.subscription && (
                      <p className="text-sm text-muted-foreground text-center">
                        {subscriptionDetails.subscription.cancelAtPeriodEnd
                          ? `Subscription expires ${formatDate(
                  ...
                  {getProAccessSource() === "dodo" &&
                    user?.dodoPayments?.expiresAt && (
                      <p className="text-sm text-muted-foreground text-center">
                        Access expires{" "}
                        {formatDate(new Date(user.dodoPayments.expiresAt))}
                      </p>
                    )}
                </div>
              ) : (
                ...
                >
                  {!user ? "Sign up for Pro" : "Upgrade to Pro"}
            ...
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <Button variant="outline" asChild>
                  <a href="mailto:zaid@scira.ai?subject=Student%20Discount%20Request">
                    Apply for discount
                  </a>
                </Button>
              </div>
          ...
          <Card className="max-w-2xl mx-auto mt-16 border-primary/20 bg-primary/5">
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Your student email has been verified. Get Pro for just
                  $5/month.
                </p>
