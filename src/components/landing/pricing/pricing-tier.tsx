...
export function PricingTier({ tierInfo, className }: PricingTierProps) {
    ...
    <div className={cn("relative", className)}>
      ...
      <div className="flex justify-center lg:justify-end">
        <div className="relative">
          {/* Background Card (Next Tier) - Positioned behind */}
          {tierInfo?.nextTier && (
                ...
                <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                  <div className="text-center">
                    <h3 className="font-[family-name:var(--font-instrument-serif)] text-3xl font-bold text-[#085983] mb-4">
                      {tierInfo.nextTier.name.toUpperCase()}
                    </h3>
                    ...
                    <div className="font-[family-name:var(--font-instrument-serif)] text-6xl font-bold text-[#085983] mb-6">
                      {tierInfo.nextTier.displayPrice}
                    </div>
                  </div>
          ...
          {/* Front Card (Current Tier) - Main active card */}
            ...
            <div className="w-80 h-96 bg-gradient-to-br from-blue-100/90 via-white/85 to-blue-50/80 backdrop-blur-md rounded-3xl shadow-2xl border-4 border-[#085983]">
              ...
              <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                <div className="text-center">
                  <h3 className="font-[family-name:var(--font-instrument-serif)] text-4xl font-bold text-[#085983] mb-6 tracking-wider">
                    {tierInfo ? (
                      ...
                      <div className="animate-pulse bg-[#085983]/20 rounded h-12 w-32 mx-auto"></div>
                    )}
                  </h3>
                  ...
                  <div className="font-[family-name:var(--font-instrument-serif)] text-7xl font-bold text-[#085983] mb-8 leading-none">
                    {tierInfo ? (
                      ...
                      <div className="animate-pulse bg-[#085983]/20 rounded h-20 w-40 mx-auto"></div>
                    )}
                  </div>
                </div>
                ...
                <div className="relative">
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-b from-[#085983] via-[#0a6b99] to-[#085983] hover:from-[#074a6b] hover:via-[#085983] hover:to-[#074a6b] text-white font-[family-name:var(--font-instrument-serif)] text-xl font-bold py-6 px-8 rounded-full shadow-2xl transition-all duration-300 hover:shadow-3xl hover:scale-105 tracking-widest border-2 border-[#085983]/50 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                    style={{
                      boxShadow:
