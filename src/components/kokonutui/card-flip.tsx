...
export default function CardFlip({
  ...
  return (
    <div
      className="relative w-full max-w-sm h-[380px] group [perspective:2000px] mx-auto"
        ...
        >
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              <h3 className="text-lg font-semibold text-[#085983] dark:text-white leading-snug tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px]">
                {title}
              </h3>
              <p className="text-sm text-[#085983]/70 dark:text-zinc-400 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px] line-clamp-2">
                {description}
              </p>
            </div>
          ...
          <div className="pt-6 mt-6 border-t border-zinc-200 dark:border-zinc-800">
            <div
              className={cn(
                ...
                "dark:from-[#085983]/10 dark:via-[#085983]/10 dark:to-[#085983]/10",
                "hover:from-[#085983]/10 hover:from-0% hover:via-[#085983]/5 hover:via-100% hover:to-transparent hover:to-100%",
                "dark:hover:from-[#085983]/20 dark:hover:from-0% dark:hover:via-[#085983]/10 dark:hover:via-100% dark:hover:to-transparent dark:hover:to-100%",
                "hover:scale-[1.02] hover:cursor-pointer"
              )}
            >
              <span className="text-sm font-semibold text-[#085983] dark:text-white transition-colors duration-300 group-hover/start:text-[#085983] dark:group-hover/start:text-[#085983]">
                Get started
              </span>
              <div className="relative group/icon">
                <div
      ...
      <style jsx global>{`
        @keyframes scale {
          0% {
            transform: scale(2);
            opacity: 0;
            box-shadow: 0px 0px 50px rgba(8, 89, 131, 0.5);
          }
          50% {
            transform: translate(0px, -5px) scale(1);
            opacity: 1;
            box-shadow: 0px 8px 20px rgba(8, 89, 131, 0.5);
          }
          100% {
