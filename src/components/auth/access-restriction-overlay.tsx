...
export function AccessRestrictionOverlay() {
  const { user } = useAuth();
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-b from-white to-blue-50/30 overflow-y-auto"
      data-fast-goal="access_restriction_view"
    >
          ...
          {user && (
            <div className="flex flex-col items-center justify-center gap-2 text-[#085983]/60">
              <span className="text-sm">
                Signed in as{" "}
                <span className="text-[#085983] font-semibold">
                  {user.email}
                </span>
              </span>
